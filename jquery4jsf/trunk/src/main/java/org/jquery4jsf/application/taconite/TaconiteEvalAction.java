...
public class TaconiteEvalAction extends AbstractTaconiteAction {
	...
	public TaconiteEvalAction(String id, List components) {
		super(id, components);
		this.id = id;
	}
	
	public TaconiteEvalAction(String id, UIComponent component) {
		super(id, component);
		this.id = id;
	...
	public void processTacconiteAction() throws IOException{
        ...
        processChildren(getFacesContext(), component);
