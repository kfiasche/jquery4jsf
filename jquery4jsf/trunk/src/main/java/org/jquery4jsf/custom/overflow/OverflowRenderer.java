...
public class OverflowRenderer extends JQueryBaseRenderer {
	
	private static String AJAX_START = "ajaxStart";
	private static String AJAX_STOP = "ajaxStop";
	...
	public void encodeEnd(FacesContext context, UIComponent component) throws IOException {
		...
		if(component instanceof Overflow)
			overflow = (Overflow)component;
		
		encodeResources(overflow);
		encodeScriptOverflow(context, overflow);
		encodeOverflowMarkup(context, overflow);
	}

	private void encodeOverflowMarkup(FacesContext context, Overflow overflow) {		
	}

	private void encodeScriptOverflow(FacesContext context, Overflow overflow) throws IOException {
        ...
        RendererUtilities.encodeImportJavascripScript(overflow, responseWriter, sb);
	}
	
	private String encodeStartEventOperation(FacesContext context, Overflow overflow){
		...
		String clientId = RendererUtilities.encodeIdInteractions(overflow, context);
	...
	private String encodeStopEventOperation(FacesContext context, Overflow overflow){
		String jQuery = RendererUtilities.getJQueryVarWidget();
