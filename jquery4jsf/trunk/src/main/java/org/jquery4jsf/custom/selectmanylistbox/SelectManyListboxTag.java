...
public class SelectManyListboxTag extends UIComponentTagBase {
	...
	protected void setProperties(UIComponent comp){
		...
		org.jquery4jsf.custom.selectmanylistbox.SelectManyListbox component = null;
		try {
			component = (org.jquery4jsf.custom.selectmanylistbox.SelectManyListbox) comp;
		...
		setBooleanProperty(getFacesContext(), component, "sortable", sortable);
		setBooleanProperty(getFacesContext(), component, "searchable", searchable);
	}

	public String getComponentType() {
		return SelectManyListbox.COMPONENT_TYPE;
	}

	public String getRendererType() {
		return "org.jquery4jsf.SelectManyListboxRenderer";
	}
