...
public class SpinnerTag extends UIComponentTagBase {
	...
	public void release(){
		...
		this.precision = null;
		this.radix = null;
		this.radixPoint = null;
		this.readOnly = null;
		this.spinnerClass = null;
		this.width = null;
	}
	...
	protected void setProperties(UIComponent comp){
		...
		org.jquery4jsf.custom.spinner.Spinner component = null;
		try {
			component = (org.jquery4jsf.custom.spinner.Spinner) comp;
		...
		setStringProperty(getFacesContext(), component, "syncWith", syncWith);
		setStringProperty(getFacesContext(), component, "step", step);
		setBooleanProperty(getFacesContext(), component, "currency", currency);
		setStringProperty(getFacesContext(), component, "format", format);
		setStringProperty(getFacesContext(), component, "groupSeparator", groupSeparator);
		setStringProperty(getFacesContext(), component, "hide", hide);
		setBooleanProperty(getFacesContext(), component, "incremental", incremental);
		setIntegerProperty(getFacesContext(), component, "max", max);
		setIntegerProperty(getFacesContext(), component, "min", min);
		setBooleanProperty(getFacesContext(), component, "mouseWheel", mouseWheel);
		setIntegerProperty(getFacesContext(), component, "padLength", padLength);
		setIntegerProperty(getFacesContext(), component, "page", page);
		setIntegerProperty(getFacesContext(), component, "precision", precision);
		setIntegerProperty(getFacesContext(), component, "radix", radix);
		setStringProperty(getFacesContext(), component, "radixPoint", radixPoint);
		setStringProperty(getFacesContext(), component, "readOnly", readOnly);
		setStringProperty(getFacesContext(), component, "spinnerClass", spinnerClass);
	...
	public String getRendererType() {
		return "org.jquery4jsf.SpinnerRenderer";
	}
	...
	public void setSyncWith(String value){
		this.syncWith = value;
	}
	...
	public void setMouseWheel(String value){
		this.mouseWheel = value;
	}

	public void setPadLength(String value){
		this.padLength = value;
	}
	...
	public void setRadix(String value){
		this.radix = value;
	}

	public void setRadixPoint(String value){
		this.radixPoint = value;
	}
	...
	public void setSpinnerClass(String value){
