...
public class WatermarkTag extends UIComponentTagBase {
	...
	public void release(){
		...
		this.animate = null;
		this.onplaceholder = null;
	}

	protected void setProperties(UIComponent comp){
		super.setProperties(comp);

		org.jquery4jsf.custom.watermark.Watermark component = null;
		try {
			component = (org.jquery4jsf.custom.watermark.Watermark) comp;
		...
		setStringProperty(getFacesContext(), component, "placeholderText", placeholderText);
		setBooleanProperty(getFacesContext(), component, "animate", animate);
		setStringProperty(getFacesContext(), component, "onplaceholder", onplaceholder);
	}
	...
	public String getRendererType() {
		return "org.jquery4jsf.WatermarkRenderer";
	}
	...
	public void setOnplaceholder(String value){
		this.onplaceholder = value;
	}
