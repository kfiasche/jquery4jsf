...
public abstract class WatermarkBaseRenderer extends JQueryInputBaseRenderer {
	...
	protected String encodeOptionComponent(StringBuffer options, Watermark watermark , FacesContext context) {
		options.append(" {\n");
		encodeOptionComponentByType(options, watermark.getPlaceholderText(), "placeholderText", null);
		encodeOptionComponentByType(options, watermark.isAnimate(), "animate", "true");
		encodeOptionComponentFunction(options, watermark.getOnplaceholder(), "placeholder", "");
