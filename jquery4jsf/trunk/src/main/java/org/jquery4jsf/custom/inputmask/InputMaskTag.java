...
public class InputMaskTag extends UIComponentTagBase {
	...
	protected void setProperties(UIComponent comp){
		...
		org.jquery4jsf.custom.inputmask.InputMask component = null;
		try {
			component = (org.jquery4jsf.custom.inputmask.InputMask) comp;
		...
		setStringProperty(getFacesContext(), component, "mask", mask);
		setStringProperty(getFacesContext(), component, "placeholder", placeholder);
		setBooleanProperty(getFacesContext(), component, "allowPartials", allowPartials);
		setStringProperty(getFacesContext(), component, "oncompleted", oncompleted);
	}

	public String getComponentType() {
		return InputMask.COMPONENT_TYPE;
	}

	public String getRendererType() {
		return "org.jquery4jsf.InputMaskRenderer";
	}
	...
	public void setAllowPartials(String value){
