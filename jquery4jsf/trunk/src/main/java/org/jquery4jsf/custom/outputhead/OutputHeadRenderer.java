...
public class OutputHeadRenderer extends JQueryBaseRenderer {
	...
	public void encodeEnd(FacesContext context, UIComponent component) throws IOException {
		...
		responseWriter.endElement(HTML.TAG_HEAD);
	}
	...
	public void encodeBegin(FacesContext context, UIComponent component) throws IOException {
		...
		ResponseWriter responseWriter = context.getResponseWriter();
		responseWriter.startElement(HTML.TAG_HEAD, outputBody);
		...
		HtmlRendererUtilities.writeHtmlAttributes(responseWriter, component, HTML.HTML_HEAD_TAG_ATTR);
	}
