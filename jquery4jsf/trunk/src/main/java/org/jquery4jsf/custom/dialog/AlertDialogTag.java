...
public class AlertDialogTag extends UIComponentTagBase {
	...
	protected void setProperties(UIComponent comp){
		...
		org.jquery4jsf.custom.dialog.AlertDialog component = null;
		try {
			component = (org.jquery4jsf.custom.dialog.AlertDialog) comp;
		...
		setStringProperty(getFacesContext(), component, "okLabel", okLabel);
		setStringProperty(getFacesContext(), component, "noLabel", noLabel);
		setMethodBindingProperty(getFacesContext(), component, "okAction", okAction);
		setMethodBindingProperty(getFacesContext(), component, "noAction", noAction);
	...
	public String getComponentType() {
		return AlertDialog.COMPONENT_TYPE;
	}

	public String getRendererType() {
		return "org.jquery4jsf.AlertDialogRenderer";
	}
	...
	public void setOkLabel(String value){
		this.okLabel = value;
	}
	...
	public void setOkAction(String value){
		this.okAction = value;
	}

	public void setNoAction(String value){
		this.noAction = value;
	}
