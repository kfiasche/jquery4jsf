				...
				<f:view>
					<h:form id="form1">
						<table>
							<tr>
								<td>
									<h:outputText id="text1" value="Auto complete" />
								</td>
								<td>
									<jq:autoComplete id="autoComplete"
										value="#{autoCompleteBean.valueOnAutoCompleteSubmit}"
										oncomplete="#{autoCompleteBean.onCompleteCities}" minChars="2" />
								</td>
							</tr>
							<tr>
								<td>
									<h:commandButton value="Ok" id="buttonOk"></h:commandButton>
								</td>
								<td>
