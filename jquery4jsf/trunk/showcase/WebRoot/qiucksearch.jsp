...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<!--body part start -->
		<div id="mainBody">
			<jsp:include page="inc/menu-quicksearch.jsp"></jsp:include>
			<!--right side start -->
			<div id="rightPan">
				<f:view>
					<jq:panel id="panel" header="Quick Search">
						<h:dataTable id="dataTable" width="100%" border="0" var="element"
							value="#{quickSearchBean.listaSearch}">
							<h:column>
								<f:facet name="header">
							...
							<h:column>
								...
								<h:outputText value="#{element.total}" />
							</h:column>
							<h:column>
								<f:facet name="header">
					...
					<jq:quickSearch target="dataTable tbody tr" position="before"
					attached="#dataTable"
					/>
				</f:view>
			</div>
