...
public class IconTag extends UIComponentTagBase {
	...
	protected void setProperties(UIComponent comp){
		...
		org.jquery4jsf.custom.icon.Icon component = null;
		try {
			component = (org.jquery4jsf.custom.icon.Icon) comp;
	...
	public String getComponentType() {
		return Icon.COMPONENT_TYPE;
	}

	public String getRendererType() {
		return "org.jquery4jsf.IconRenderer";
	}
