			...
			<div id="rightPan">
				<f:view>
					<div class="demo">
						...
						<jq:div id="accordionResizer"
							style="padding:10px; width:350px; height:220px;"
							...
							<jq:resizable minHeight="140"
								onresize="$('#accordion').accordion('resize');"></jq:resizable>
						</jq:div>
						<jq:panel
							style="margin-top:7px; padding:10px; width:350px; height:50px;"
							header="I'm another panel">
						I'm another panel
					</jq:panel>
					</div>
					<!-- End demo -->
