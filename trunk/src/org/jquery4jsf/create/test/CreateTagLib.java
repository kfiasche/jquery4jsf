...
public class CreateTagLib {
	...
	public static void main(String[] args) {
		...
		Field[] fieldsb = HtmlInputText.class.getSuperclass().getSuperclass().getDeclaredFields();
		Field[] fieldsc = HtmlInputText.class.getSuperclass().getDeclaredFields();
		Field[] fieldsd = HtmlInputText.class.getDeclaredFields();
