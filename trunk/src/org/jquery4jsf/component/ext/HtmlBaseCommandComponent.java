...
public abstract class HtmlBaseCommandComponent extends UICommand implements HtmlElementEvent,HtmlKeyEvent, HtmlMouseEvent {
	...
	public String getType() {
		String value = (String) getLocalOrValueBindingValue(type, "type");
		return value != null ? value : "submit";
	}
